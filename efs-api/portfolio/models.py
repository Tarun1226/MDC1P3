...
class Stock(models.Model):
    ...
    def current_stock_price(self):
        ...
        api_key = '&apikey = PL9SIHDOZ7MXQ6L6'
...
class Mutualfund(models.Model):
    ...
    category = models.CharField(max_length=50)
    description = models.CharField(max_length=200)
    acquiredm_value = models.DecimalField(max_digits=10, decimal_places=2)
    acquiredm_date = models.DateField(default=timezone.now)
    recentm_value = models.DecimalField(max_digits=10, decimal_places=2)
    recentm_date = models.DateField(default=timezone.now, blank=True, null=True)

    def created(self):
        self.acquiredm_date = timezone.now()
        self.save()

    def updated(self):
        self.recentm_date = timezone.now()
        self.save()
    ...
    def results_by_mutualfund(self):
        return self.recentm_value - self.acquiredm_value
